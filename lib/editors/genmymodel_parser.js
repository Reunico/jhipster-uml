...
function getComment(ownedEnd) {
  if (ownedEnd['xmi:Extension'][0].eAnnotations.eAnnotations && ownedEnd['xmi:Extension'][0].eAnnotations[0].details) {
    for (let i = 0; i < ownedEnd['xmi:Extension'][0].eAnnotations[0].details.length; i++) {
      const element = ownedEnd['xmi:Extension'][0].eAnnotations[0].details[i];
...
function addRegularField(element, classId) {
  ...
  // } else if (!element.$.type) {
    throw new BuildException(
      ...
      `The field '${element.$.name}' does not possess any type. Element Structure - ${Object.entries(element.$)}`);
  } else {
  ...
  if (element['xmi:Extension'][0].eAnnotations && element['xmi:Extension'][0].eAnnotations[0].details
    && element['xmi:Extension'][0].eAnnotations[0].details.length > 1
    && element['xmi:Extension'][0].eAnnotations[0].details[1].$.key === 'gmm-documentation') {
    fieldData.comment = element['xmi:Extension'][0].eAnnotations[0].details[1].$.value;
  }
